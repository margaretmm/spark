...
public class CreditSource implements SourceFunction<DataCredit> {
    ...
    public CreditSource(String dataFilePath) {
        this(dataFilePath, 1);
    }

    public CreditSource(String dataFilePath, int servingSpeedFactor) {
        this.dataFilePath = dataFilePath;
        this.servingSpeed = servingSpeedFactor;
    }

    @Override
    public void run(SourceContext<DataCredit> sourceContext) throws Exception {
        ...
        while (reader.ready() && (line = reader.readLine()) != null) {
            DataCredit diag = DataCredit.instanceFromString(line);
            if (diag == null){
                continue;
            }
    ...
    public long getEventTime(DataCredit diag) {
